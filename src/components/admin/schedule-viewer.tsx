...
import { Download, CalendarCheck, ChevronLeft, Search, Save, FilePenLine, Wand, Share } from 'lucide-react';
...
export function ScheduleViewer({ schedule, adminEmail, showControls = true, allSubjects, allFaculty, allRooms }: ScheduleViewerProps) {
        ...
        <div className="flex flex-col gap-4 md:flex-row md:items-center md:justify-between">
            <div className="flex items-start gap-4">
                ...
                <div className="grid gap-1">
                    ...
                    <CardDescription>
                       {showControls ? 'This is the currently active schedule. Click on any cell to edit it.' : 'Your generated schedule will appear here...'}
                    </CardDescription>
                </div>
            </div>
            {showControls && (
                                                        ...
                                                        <TableRow key={rowIndex}>
                                                            {row.map((cell, cellIndex) => {
                                                                ...
                                                                return (
                                                                    <TableCell 
                                                                        key={cellIndex} 
                                                                        className={cn("whitespace-nowrap", cellIndex === 0 ? "font-medium" : (showControls ? "cursor-pointer hover:bg-muted/50" : "")) }
                                                                        onClick={() => {
                                                                            if (cellIndex > 0 && showControls) {
                                                                                handleCellClick(cellIdentifier, cell);
                                                                            }
                                                                        }}
                                                                    >
                                                                        {cellIndex > 0 && showControls ? (
