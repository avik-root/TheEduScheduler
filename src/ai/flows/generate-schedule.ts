...
3.  **Priority Subjects**: Subjects marked as 'Priority' MUST be scheduled as double-duration sessions (two consecutive periods, e.g., "09:00-10:40").
...
6.  **Lab Scheduling**:
    - Lab subjects (1 credit) MUST be scheduled as a single 100-minute double-period session.
